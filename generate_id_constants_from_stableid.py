...
DATA_JSON = {
    ...
    "Linux": HOME_DIR + "/Documents/StarCraft II/stableid.json",
}
...
def generate_python_code(enums):
    ...
    for name, body in enums.items():
        ...
        ids_file_path = (idsdir / FILE_TRANSLATE[name]).with_suffix(".py")
        ...
        try:
            ...
            print(f"Black is not installed. Please use 'pip install black' to install black formatter.\nCould not autoformat file {ids_file_path}")
